    ...
    <main style={{
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
          ...
          <button style={{
            background: '#C9A882', color: '#fff', border: 'none',
            borderRadius: '20px', padding: '6px 16px', fontSize: '13px', cursor: 'pointer'
          }}>시작하기</button>
        </div>
      </nav>
      ...
      <section style={{ padding: '4rem 2rem', textAlign: 'center' }}>
        ...
        <button style={{
          background: '#C9A882', color: '#fff', border: 'none',
          borderRadius: '24px', padding: '12px 28px', fontSize: '15px', cursor: 'pointer'
        }}>무료로 시작하기</button>
      </section>
    </main>
  )
